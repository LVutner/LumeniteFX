...
LightCompositor is a depth buffer based raytracing shader written for ReShade. It combines a few screenspace raytraced effects in one package that are overlayed on the final color buffer: Bounce lighting, occlusion shadows and planar reflections. To be released in early 2026.
